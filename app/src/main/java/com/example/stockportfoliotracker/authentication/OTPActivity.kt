...
import com.example.stockportfoliotracker.MainActivity
...
//                        val user = data.UserInfo(
//                            name = name,
//                            phonenumber = number,
//                            uid = uid
//                        )
                        startActivity(Intent(this, MainActivity::class.java))
//                        database.reference.child("users").child(uid).setValue(number).addOnSuccessListener {
//
//                        }
                    }else{
                        dialog.dismiss()
